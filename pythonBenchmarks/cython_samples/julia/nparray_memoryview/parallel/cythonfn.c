...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/usr/local/lib/python3.9/dist-packages/numpy/core/include/numpy/arrayobject.h",
            "/usr/local/lib/python3.9/dist-packages/numpy/core/include/numpy/arrayscalars.h",
            "/usr/local/lib/python3.9/dist-packages/numpy/core/include/numpy/ndarrayobject.h",
            "/usr/local/lib/python3.9/dist-packages/numpy/core/include/numpy/ndarraytypes.h",
            "/usr/local/lib/python3.9/dist-packages/numpy/core/include/numpy/ufuncobject.h"
        ],
        "extra_compile_args": [
            "-fopenmp"
        ],
