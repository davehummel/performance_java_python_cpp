...
static PyObject *__pyx_pw_8cythonfn_1calculate_z(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("calculate_z (wrapper)", 0);
  {
    ...
    __pyx_v_cs = __Pyx_PyComplex_As___pyx_t_double_complex(values[2]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
  }
 ...
 *     cdef unsigned int i, n
 */
  __pyx_tuple__21 = PyTuple_Pack(7, __pyx_n_s_maxiter, __pyx_n_s_zs, __pyx_n_s_cs, __pyx_n_s_i, __pyx_n_s_n, __pyx_n_s_z, __pyx_n_s_output); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 4, __pyx_L1_error)
